// Generated from Symbol Table data
...
class AppComponent {
    ...
    updateProductDetails() {
        ...
        if (nameEl) nameEl.textContent = this.selectedProduct.name;
        if (priceEl) priceEl.textContent = '$' + this.selectedProduct.price;
        if (imageEl) {
            imageEl.src = this.selectedProduct.imageUrl;
            imageEl.alt = this.selectedProduct.name;
        }
    }
